...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark m1514minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc  reason: not valid java name */
    long m1515minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    ComparableTimeMark m1516plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static ComparableTimeMark m1517minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.m1516plusLRDsOJo(Duration.m1575unaryMinusUwyO8pc(j));
        }
        ...
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark comparableTimeMark2) {
            ...
            return Duration.m1521compareToLRDsOJo(comparableTimeMark.m1515minusUwyO8pc(comparableTimeMark2), Duration.Companion.m1625getZEROUwyO8pc());
        }
    }
}
