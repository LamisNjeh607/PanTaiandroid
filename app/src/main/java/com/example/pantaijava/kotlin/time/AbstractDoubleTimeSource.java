...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1500minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m1517minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m1498elapsedNowUwyO8pc() {
            return Duration.m1557minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m1503plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1558plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1501minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
            ...
            if (comparableTimeMark instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual((Object) this.timeSource, (Object) doubleTimeMark.timeSource)) {
                    if (Duration.m1527equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1554isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m1625getZEROUwyO8pc();
                    }
                    long r2 = Duration.m1557minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m1527equalsimpl0(duration, Duration.m1575unaryMinusUwyO8pc(r2)) ? Duration.Companion.m1625getZEROUwyO8pc() : Duration.m1558plusLRDsOJo(duration, r2);
                }
            }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) obj).timeSource) && Duration.m1527equalsimpl0(m1501minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m1625getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m1550hashCodeimpl(Duration.m1558plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m1571toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1625getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
