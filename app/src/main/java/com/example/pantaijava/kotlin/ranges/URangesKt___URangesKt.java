...
class URangesKt___URangesKt {
    ...
    public static final UInt firstOrNull(UIntProgression uIntProgression) {
        ...
        return UInt.m279boximpl(uIntProgression.m1409getFirstpVg5ArA());
    }
    ...
    public static final ULong firstOrNull(ULongProgression uLongProgression) {
        ...
        return ULong.m358boximpl(uLongProgression.m1418getFirstsVKNKU());
    }
    ...
    public static final UInt lastOrNull(UIntProgression uIntProgression) {
        ...
        return UInt.m279boximpl(uIntProgression.m1410getLastpVg5ArA());
    }
    ...
    public static final ULong lastOrNull(ULongProgression uLongProgression) {
        ...
        return ULong.m358boximpl(uLongProgression.m1419getLastsVKNKU());
    }
    ...
    public static final UInt randomOrNull(UIntRange uIntRange, Random random) {
        ...
        return UInt.m279boximpl(URandomKt.nextUInt(random, uIntRange));
    }
    ...
    public static final ULong randomOrNull(ULongRange uLongRange, Random random) {
        ...
        return ULong.m358boximpl(URandomKt.nextULong(random, uLongRange));
    }

    /* renamed from: contains-biwQdVI  reason: not valid java name */
    private static final boolean m1446containsbiwQdVI(UIntRange uIntRange, UInt uInt) {
        Intrinsics.checkNotNullParameter(uIntRange, "$this$contains");
        return uInt != null && uIntRange.m1414containsWZ4Q5Ns(uInt.m337unboximpl());
    }

    /* renamed from: contains-GYNo2lE  reason: not valid java name */
    private static final boolean m1442containsGYNo2lE(ULongRange uLongRange, ULong uLong) {
        Intrinsics.checkNotNullParameter(uLongRange, "$this$contains");
        return uLong != null && uLongRange.m1423containsVKZWuLQ(uLong.m416unboximpl());
    }

    /* renamed from: contains-68kG9v0  reason: not valid java name */
    public static final boolean m1441contains68kG9v0(UIntRange uIntRange, byte b) {
        Intrinsics.checkNotNullParameter(uIntRange, "$this$contains");
        return uIntRange.m1414containsWZ4Q5Ns(UInt.m285constructorimpl(b & UByte.MAX_VALUE));
    }

    /* renamed from: contains-ULb-yJY  reason: not valid java name */
    public static final boolean m1444containsULbyJY(ULongRange uLongRange, byte b) {
        Intrinsics.checkNotNullParameter(uLongRange, "$this$contains");
        return uLongRange.m1423containsVKZWuLQ(ULong.m364constructorimpl(((long) b) & 255));
    }

    /* renamed from: contains-Gab390E  reason: not valid java name */
    public static final boolean m1443containsGab390E(ULongRange uLongRange, int i) {
        Intrinsics.checkNotNullParameter(uLongRange, "$this$contains");
        return uLongRange.m1423containsVKZWuLQ(ULong.m364constructorimpl(((long) i) & 4294967295L));
    }

    /* renamed from: contains-fz5IDCE  reason: not valid java name */
    public static final boolean m1447containsfz5IDCE(UIntRange uIntRange, long j) {
        Intrinsics.checkNotNullParameter(uIntRange, "$this$contains");
        return ULong.m364constructorimpl(j >>> 32) == 0 && uIntRange.m1414containsWZ4Q5Ns(UInt.m285constructorimpl((int) j));
    }

    /* renamed from: contains-ZsK3CEQ  reason: not valid java name */
    public static final boolean m1445containsZsK3CEQ(UIntRange uIntRange, short s) {
        Intrinsics.checkNotNullParameter(uIntRange, "$this$contains");
        return uIntRange.m1414containsWZ4Q5Ns(UInt.m285constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: contains-uhHAxoY  reason: not valid java name */
    public static final boolean m1448containsuhHAxoY(ULongRange uLongRange, short s) {
        Intrinsics.checkNotNullParameter(uLongRange, "$this$contains");
        return uLongRange.m1423containsVKZWuLQ(ULong.m364constructorimpl(((long) s) & 65535));
    }

    /* renamed from: downTo-Kr8caGY  reason: not valid java name */
    public static final UIntProgression m1451downToKr8caGY(byte b, byte b2) {
        return UIntProgression.Companion.m1411fromClosedRangeNkh28Cs(UInt.m285constructorimpl(b & UByte.MAX_VALUE), UInt.m285constructorimpl(b2 & UByte.MAX_VALUE), -1);
    }
    ...
    public static final ULongProgression m1452downToeb3DHEI(long j, long j2) {
        return ULongProgression.Companion.m1420fromClosedRange7ftBX0g(j, j2, -1);
    }

    /* renamed from: downTo-5PvTz6A  reason: not valid java name */
    public static final UIntProgression m1449downTo5PvTz6A(short s, short s2) {
        return UIntProgression.Companion.m1411fromClosedRangeNkh28Cs(UInt.m285constructorimpl(s & UShort.MAX_VALUE), UInt.m285constructorimpl(s2 & UShort.MAX_VALUE), -1);
    }
    ...
    public static final UIntProgression step(UIntProgression uIntProgression, int i) {
        ...
        int r1 = uIntProgression.m1409getFirstpVg5ArA();
        int r2 = uIntProgression.m1410getLastpVg5ArA();
        if (uIntProgression.getStep() <= 0) {
            i = -i;
        }
        return companion.m1411fromClosedRangeNkh28Cs(r1, r2, i);
    }
    ...
    public static final ULongProgression step(ULongProgression uLongProgression, long j) {
        ...
        long r5 = uLongProgression.m1418getFirstsVKNKU();
        long r7 = uLongProgression.m1419getLastsVKNKU();
        if (uLongProgression.getStep() <= 0) {
            j = -j;
        }
        return companion.m1420fromClosedRange7ftBX0g(r5, r7, j);
    }
    ...
    public static final UIntRange m1455untilKr8caGY(byte b, byte b2) {
        ...
        return new UIntRange(UInt.m285constructorimpl(b & UByte.MAX_VALUE), UInt.m285constructorimpl(UInt.m285constructorimpl(b3) - 1), (DefaultConstructorMarker) null);
    }
    ...
    public static final UIntRange m1454untilJ1ME1BU(int i, int i2) {
        ...
        return new UIntRange(i, UInt.m285constructorimpl(i2 - 1), (DefaultConstructorMarker) null);
    }
    ...
    public static final ULongRange m1456untileb3DHEI(long j, long j2) {
        ...
        return new ULongRange(j, ULong.m364constructorimpl(j2 - ULong.m364constructorimpl(((long) 1) & 4294967295L)), (DefaultConstructorMarker) null);
    }
    ...
    public static final UIntRange m1453until5PvTz6A(short s, short s2) {
        ...
        return new UIntRange(UInt.m285constructorimpl(s & UShort.MAX_VALUE), UInt.m285constructorimpl(UInt.m285constructorimpl(s3) - 1), (DefaultConstructorMarker) null);
    }
    ...
    public static final int m1437coerceInWZ9TVnA(int i, int i2, int i3) {
        if (Integer.compareUnsigned(i2, i3) > 0) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UInt.m331toStringimpl(i3) + " is less than minimum " + UInt.m331toStringimpl(i2) + '.');
    ...
    public static final long m1439coerceInsambcqE(long j, long j2, long j3) {
        if (Long.compareUnsigned(j2, j3) > 0) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ULong.m410toStringimpl(j3) + " is less than minimum " + ULong.m410toStringimpl(j2) + '.');
    ...
    public static final byte m1438coerceInb33U2AM(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UByte.m252toStringimpl(b3) + " is less than minimum " + UByte.m252toStringimpl(b2) + '.');
    }
    ...
    public static final short m1436coerceInVKSA0NQ(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UShort.m515toStringimpl(s3) + " is less than minimum " + UShort.m515toStringimpl(s2) + '.');
    }

    /* renamed from: coerceIn-wuiCnnA  reason: not valid java name */
    public static final int m1440coerceInwuiCnnA(int i, ClosedRange<UInt> closedRange) {
        Intrinsics.checkNotNullParameter(closedRange, "range");
        if (closedRange instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m279boximpl(i), (ClosedFloatingPointRange) closedRange)).m337unboximpl();
        }
        if (closedRange.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + closedRange + '.');
        } else if (Integer.compareUnsigned(i, closedRange.getStart().m337unboximpl()) < 0) {
            return closedRange.getStart().m337unboximpl();
        } else {
            return Integer.compareUnsigned(i, closedRange.getEndInclusive().m337unboximpl()) > 0 ? closedRange.getEndInclusive().m337unboximpl() : i;
        }
    }

    /* renamed from: coerceIn-JPwROB0  reason: not valid java name */
    public static final long m1435coerceInJPwROB0(long j, ClosedRange<ULong> closedRange) {
        Intrinsics.checkNotNullParameter(closedRange, "range");
        if (closedRange instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m358boximpl(j), (ClosedFloatingPointRange) closedRange)).m416unboximpl();
        }
        if (closedRange.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + closedRange + '.');
        } else if (Long.compareUnsigned(j, closedRange.getStart().m416unboximpl()) < 0) {
            return closedRange.getStart().m416unboximpl();
        } else {
            return Long.compareUnsigned(j, closedRange.getEndInclusive().m416unboximpl()) > 0 ? closedRange.getEndInclusive().m416unboximpl() : j;
        }
    }
}
