...
public final class UStringsKt {
    ...
    public static final String m1495toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1497toStringolVBNx4(short s, int i) {
    ...
    public static final String m1496toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(((long) i) & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m1494toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m258unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m521unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m337unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m416unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m337unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m285constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m202boximpl(UByte.m208constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m337unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m285constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m465boximpl(UShort.m471constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m285constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m285constructorimpl(i3 * r3);
            int r7 = UInt.m285constructorimpl(UInt.m285constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m364constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m364constructorimpl(j * r5);
            long r13 = ULong.m364constructorimpl(ULong.m364constructorimpl(((long) UInt.m285constructorimpl(digitOf)) & 4294967295L) + r9);
