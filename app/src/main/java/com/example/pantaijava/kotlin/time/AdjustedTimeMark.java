...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1511getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1512minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1662minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1510elapsedNowUwyO8pc() {
        return Duration.m1557minusLRDsOJo(this.mark.m1659elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1513plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1558plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
