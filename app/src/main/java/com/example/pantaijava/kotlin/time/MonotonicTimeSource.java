...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m1656markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1668constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1655elapsedFrom6eNON_k(long j) {
    ...
    public final long m1654differenceBetweenfRLX17w(long j, long j2) {
        return LongSaturatedMathKt.saturatingOriginsDiff(j, j2, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m1653adjustReading6QKq23U(long j, long j2) {
        return TimeSource.Monotonic.ValueTimeMark.m1668constructorimpl(LongSaturatedMathKt.m1651saturatingAddNuflL3o(j, DurationUnit.NANOSECONDS, j2));
    }
}
