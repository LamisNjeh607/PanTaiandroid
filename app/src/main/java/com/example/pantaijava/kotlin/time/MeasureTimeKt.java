...
public final class MeasureTimeKt {
    public static final long measureTime(Function0<Unit> function0) {
        ...
        long r0 = TimeSource.Monotonic.INSTANCE.m1664markNowz9LOYto();
        function0.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1669elapsedNowUwyO8pc(r0);
    }
    ...
    public static final long measureTime(TimeSource.Monotonic monotonic, Function0<Unit> function0) {
        ...
        Intrinsics.checkNotNullParameter(function0, "block");
        long r0 = monotonic.m1664markNowz9LOYto();
        function0.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1669elapsedNowUwyO8pc(r0);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(function0, "block");
        return new TimedValue<>(function0.invoke(), TimeSource.Monotonic.ValueTimeMark.m1669elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m1664markNowz9LOYto()), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(TimeSource.Monotonic monotonic, Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(monotonic, "<this>");
        Intrinsics.checkNotNullParameter(function0, "block");
        return new TimedValue<>(function0.invoke(), TimeSource.Monotonic.ValueTimeMark.m1669elapsedNowUwyO8pc(monotonic.m1664markNowz9LOYto()), (DefaultConstructorMarker) null);
    }
}
