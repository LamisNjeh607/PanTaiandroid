...
public final class UnsignedKt {
    ...
    public static final int m542uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m285constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* renamed from: uintDivide-J1ME1BU  reason: not valid java name */
    public static final int m541uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m285constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m543ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m364constructorimpl(0) : ULong.m364constructorimpl(1);
        }
        if (j >= 0) {
            return ULong.m364constructorimpl(j / j2);
        }
        int i = 1;
        long j3 = ((j >>> 1) / j2) << 1;
        if (Long.compareUnsigned(ULong.m364constructorimpl(j - (j3 * j2)), ULong.m364constructorimpl(j2)) < 0) {
            i = 0;
        }
        return ULong.m364constructorimpl(j3 + ((long) i));
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m544ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m364constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m364constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m364constructorimpl(j3), ULong.m364constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m364constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        return UInt.m285constructorimpl(UInt.m285constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m285constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m364constructorimpl((long) d);
        }
        return ULong.m364constructorimpl(ULong.m364constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
