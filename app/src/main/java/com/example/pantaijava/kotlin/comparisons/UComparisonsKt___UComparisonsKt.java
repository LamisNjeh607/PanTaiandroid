...
class UComparisonsKt___UComparisonsKt {
    ...
    private static final int m1373maxOfWZ9TVnA(int i, int i2, int i3) {
        return UComparisonsKt.m1368maxOfJ1ME1BU(i, UComparisonsKt.m1368maxOfJ1ME1BU(i2, i3));
    }

    /* renamed from: maxOf-sambcqE  reason: not valid java name */
    private static final long m1377maxOfsambcqE(long j, long j2, long j3) {
        return UComparisonsKt.m1376maxOfeb3DHEI(j, UComparisonsKt.m1376maxOfeb3DHEI(j2, j3));
    }

    /* renamed from: maxOf-b33U2AM  reason: not valid java name */
    private static final byte m1375maxOfb33U2AM(byte b, byte b2, byte b3) {
        return UComparisonsKt.m1369maxOfKr8caGY(b, UComparisonsKt.m1369maxOfKr8caGY(b2, b3));
    }

    /* renamed from: maxOf-VKSA0NQ  reason: not valid java name */
    private static final short m1372maxOfVKSA0NQ(short s, short s2, short s3) {
        return UComparisonsKt.m1367maxOf5PvTz6A(s, UComparisonsKt.m1367maxOf5PvTz6A(s2, s3));
    }

    /* renamed from: maxOf-Md2H83M  reason: not valid java name */
    public static final int m1370maxOfMd2H83M(int i, int... iArr) {
        Intrinsics.checkNotNullParameter(iArr, "other");
        int r0 = UIntArray.m346getSizeimpl(iArr);
        for (int i2 = 0; i2 < r0; i2++) {
            i = UComparisonsKt.m1368maxOfJ1ME1BU(i, UIntArray.m345getpVg5ArA(iArr, i2));
        }
        return i;
    }

    /* renamed from: maxOf-R03FKyM  reason: not valid java name */
    public static final long m1371maxOfR03FKyM(long j, long... jArr) {
        Intrinsics.checkNotNullParameter(jArr, "other");
        int r0 = ULongArray.m425getSizeimpl(jArr);
        for (int i = 0; i < r0; i++) {
            j = UComparisonsKt.m1376maxOfeb3DHEI(j, ULongArray.m424getsVKNKU(jArr, i));
        }
        return j;
    }

    /* renamed from: maxOf-Wr6uiD8  reason: not valid java name */
    public static final byte m1374maxOfWr6uiD8(byte b, byte... bArr) {
        Intrinsics.checkNotNullParameter(bArr, "other");
        int r0 = UByteArray.m267getSizeimpl(bArr);
        for (int i = 0; i < r0; i++) {
            b = UComparisonsKt.m1369maxOfKr8caGY(b, UByteArray.m266getw2LRezQ(bArr, i));
        }
        return b;
    }

    /* renamed from: maxOf-t1qELG4  reason: not valid java name */
    public static final short m1378maxOft1qELG4(short s, short... sArr) {
        Intrinsics.checkNotNullParameter(sArr, "other");
        int r0 = UShortArray.m530getSizeimpl(sArr);
        for (int i = 0; i < r0; i++) {
            s = UComparisonsKt.m1367maxOf5PvTz6A(s, UShortArray.m529getMh2AYeg(sArr, i));
        }
        return s;
    }
    ...
    private static final int m1385minOfWZ9TVnA(int i, int i2, int i3) {
        return UComparisonsKt.m1380minOfJ1ME1BU(i, UComparisonsKt.m1380minOfJ1ME1BU(i2, i3));
    }

    /* renamed from: minOf-sambcqE  reason: not valid java name */
    private static final long m1389minOfsambcqE(long j, long j2, long j3) {
        return UComparisonsKt.m1388minOfeb3DHEI(j, UComparisonsKt.m1388minOfeb3DHEI(j2, j3));
    }

    /* renamed from: minOf-b33U2AM  reason: not valid java name */
    private static final byte m1387minOfb33U2AM(byte b, byte b2, byte b3) {
        return UComparisonsKt.m1381minOfKr8caGY(b, UComparisonsKt.m1381minOfKr8caGY(b2, b3));
    }

    /* renamed from: minOf-VKSA0NQ  reason: not valid java name */
    private static final short m1384minOfVKSA0NQ(short s, short s2, short s3) {
        return UComparisonsKt.m1379minOf5PvTz6A(s, UComparisonsKt.m1379minOf5PvTz6A(s2, s3));
    }

    /* renamed from: minOf-Md2H83M  reason: not valid java name */
    public static final int m1382minOfMd2H83M(int i, int... iArr) {
        Intrinsics.checkNotNullParameter(iArr, "other");
        int r0 = UIntArray.m346getSizeimpl(iArr);
        for (int i2 = 0; i2 < r0; i2++) {
            i = UComparisonsKt.m1380minOfJ1ME1BU(i, UIntArray.m345getpVg5ArA(iArr, i2));
        }
        return i;
    }

    /* renamed from: minOf-R03FKyM  reason: not valid java name */
    public static final long m1383minOfR03FKyM(long j, long... jArr) {
        Intrinsics.checkNotNullParameter(jArr, "other");
        int r0 = ULongArray.m425getSizeimpl(jArr);
        for (int i = 0; i < r0; i++) {
            j = UComparisonsKt.m1388minOfeb3DHEI(j, ULongArray.m424getsVKNKU(jArr, i));
        }
        return j;
    }

    /* renamed from: minOf-Wr6uiD8  reason: not valid java name */
    public static final byte m1386minOfWr6uiD8(byte b, byte... bArr) {
        Intrinsics.checkNotNullParameter(bArr, "other");
        int r0 = UByteArray.m267getSizeimpl(bArr);
        for (int i = 0; i < r0; i++) {
            b = UComparisonsKt.m1381minOfKr8caGY(b, UByteArray.m266getw2LRezQ(bArr, i));
        }
        return b;
    }

    /* renamed from: minOf-t1qELG4  reason: not valid java name */
    public static final short m1390minOft1qELG4(short s, short... sArr) {
        Intrinsics.checkNotNullParameter(sArr, "other");
        int r0 = UShortArray.m530getSizeimpl(sArr);
        for (int i = 0; i < r0; i++) {
            s = UComparisonsKt.m1379minOf5PvTz6A(s, UShortArray.m529getMh2AYeg(sArr, i));
        }
        return s;
    }
}
