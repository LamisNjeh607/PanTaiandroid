...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m260constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m271setVurrAj0(r0, i, r2.m258unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m339constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m350setVXSXFK8(r0, i, r2.m337unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m418constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m429setk8EXiF4(r0, i, r2.m416unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m523constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m534set01HTLdE(r0, i, r2.m521unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m285constructorimpl(i + r1.m337unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m364constructorimpl(j + r2.m416unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m285constructorimpl(i + UInt.m285constructorimpl(r1.m258unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m285constructorimpl(i + UInt.m285constructorimpl(r1.m521unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
