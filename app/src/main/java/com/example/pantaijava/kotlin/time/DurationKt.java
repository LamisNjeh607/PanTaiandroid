...
public final class DurationKt {
    ...
    private static final long m1649timesmvk6XK0(int i, long j) {
        return Duration.m1560timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final long m1648timeskIfJnKk(double d, long j) {
        return Duration.m1559timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        if (length != 0) {
            long r82 = Duration.Companion.m1625getZEROUwyO8pc();
            ...
            if (length > i) {
                ...
                if (str2.charAt(i) == 'P') {
                                ...
                                if (charSequence.length() != 0) {
                                    ...
                                    if (durationUnit == null || durationUnit.compareTo(durationUnitByIsoChar) > 0) {
                                        ...
                                        if (durationUnitByIsoChar != DurationUnit.SECONDS || indexOf$default <= 0) {
                                            r82 = Duration.m1558plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                                        } else {
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring2 = substring.substring(0, indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring2, "substring(...)");
                                            long r83 = Duration.m1558plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring3 = substring.substring(indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                                            r82 = Duration.m1558plusLRDsOJo(r83, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                                        }
                    ...
                    if (!z) {
                        ...
                        if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                            r82 = Duration.Companion.m1623getINFINITEUwyO8pc();
                        } else {
                            boolean z7 = !z4;
                            ...
                            while (i < length) {
                                ...
                                if (charSequence3.length() != 0) {
                                    ...
                                    int i5 = length3;
                                    while (i5 < str.length() && 'a' <= (r11 = str2.charAt(i5)) && r11 < '{') {
                                        i5++;
                                    }
                                    Intrinsics.checkNotNull(str2, "null cannot be cast to non-null type java.lang.String");
                                    ...
                                    if (durationUnit2 == null || durationUnit2.compareTo(durationUnitByShortName) > 0) {
                                        ...
                                        if (indexOf$default2 > 0) {
                                            ...
                                            long r4 = Duration.m1558plusLRDsOJo(r82, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                                            Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                                            String substring7 = substring4.substring(indexOf$default2);
                                            Intrinsics.checkNotNullExpressionValue(substring7, str4);
                                            r8 = Duration.m1558plusLRDsOJo(r4, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                                            if (i < length) {
                                                throw new IllegalArgumentException("Fractional component must be last");
                                            }
                                        } else {
                                            r8 = Duration.m1558plusLRDsOJo(r82, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                                        }
                                        str5 = str7;
                ...
                if (z2) {
                    return Duration.m1575unaryMinusUwyO8pc(r82);
                }
                return r82;
            }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1522constructorimpl(j << 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1522constructorimpl((j << 1) + 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1522constructorimpl((j << 1) + ((long) i));
    }
