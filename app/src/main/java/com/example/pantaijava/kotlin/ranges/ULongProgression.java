...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1394getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m364constructorimpl(j ^ ULong.m364constructorimpl(j >>> 32))) * 31) + ((int) ULong.m364constructorimpl(j2 ^ ULong.m364constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(ULong.m410toStringimpl(this.first)).append("..").append(ULong.m410toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder().append(ULong.m410toStringimpl(this.first)).append(" downTo ").append(ULong.m410toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
