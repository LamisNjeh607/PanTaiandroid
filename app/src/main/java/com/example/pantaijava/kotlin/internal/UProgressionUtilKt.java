...
public final class UProgressionUtilKt {
    ...
    private static final int m1392differenceModuloWZ9TVnA(int i, int i2, int i3) {
        ...
        int r1 = UInt.m285constructorimpl(remainderUnsigned - remainderUnsigned2);
        return compareUnsigned >= 0 ? r1 : UInt.m285constructorimpl(r1 + i3);
    }
    ...
    private static final long m1393differenceModulosambcqE(long j, long j2, long j3) {
        ...
        long r1 = ULong.m364constructorimpl(remainderUnsigned - remainderUnsigned2);
        return compareUnsigned >= 0 ? r1 : ULong.m364constructorimpl(r1 + j3);
    }
    ...
    public static final int m1395getProgressionLastElementNkh28Cs(int i, int i2, int i3) {
        if (i3 > 0) {
            ...
            return UInt.m285constructorimpl(i2 - m1392differenceModuloWZ9TVnA(i2, i, UInt.m285constructorimpl(i3)));
        } else if (i3 < 0) {
            return Integer.compareUnsigned(i, i2) <= 0 ? i2 : UInt.m285constructorimpl(i2 + m1392differenceModuloWZ9TVnA(i, i2, UInt.m285constructorimpl(-i3)));
        } else {
    ...
    public static final long m1394getProgressionLastElement7ftBX0g(long j, long j2, long j3) {
        ...
        if (i > 0) {
            ...
            return ULong.m364constructorimpl(j2 - m1393differenceModulosambcqE(j2, j, ULong.m364constructorimpl(j3)));
        } else if (i >= 0) {
            throw new IllegalArgumentException("Step is zero.");
        } else if (Long.compareUnsigned(j, j2) <= 0) {
            return j2;
        } else {
            return ULong.m364constructorimpl(j2 + m1393differenceModulosambcqE(j, j2, ULong.m364constructorimpl(-j3)));
        }
    }
}
