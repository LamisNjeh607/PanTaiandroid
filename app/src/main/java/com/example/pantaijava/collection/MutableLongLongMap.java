...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final void plusAssign(LongLongMap longLongMap) {
        Intrinsics.checkNotNullParameter(longLongMap, "from");
        putAll(longLongMap);
    }
    ...
    private final void adjustStorage() {
        if (this._capacity <= 8 || Long.compareUnsigned(ULong.m364constructorimpl(ULong.m364constructorimpl((long) this._size) * 32), ULong.m364constructorimpl(ULong.m364constructorimpl((long) this._capacity) * 25)) > 0) {
    ...
    public final void putAll(LongLongMap longLongMap) {
        ...
        Intrinsics.checkNotNullParameter(longLongMap2, "from");
