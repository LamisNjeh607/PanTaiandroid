...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public final void smoothScrollBy(int i, int i2) {
        smoothScrollBy(i, i2, DNSConstants.PROBE_WAIT_INTERVAL, false);
    }
    ...
    public final void smoothScrollTo(int i, int i2) {
        smoothScrollTo(i, i2, DNSConstants.PROBE_WAIT_INTERVAL, false);
    }
    ...
    public void smoothScrollTo(int i, int i2, boolean z) {
        smoothScrollTo(i, i2, DNSConstants.PROBE_WAIT_INTERVAL, z);
    }
