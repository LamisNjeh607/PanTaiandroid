...
public class FontsContractCompat {
    ...
    public static Typeface getFontSync(Context context, FontRequest fontRequest, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z, int i, int i2) {
        ...
        return requestFont(context, (List<FontRequest>) TypefaceCompat$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i2, z, i, ResourcesCompat.FontCallback.getHandler(handler), (FontRequestCallback) resourcesCallbackAdapter);
    }
