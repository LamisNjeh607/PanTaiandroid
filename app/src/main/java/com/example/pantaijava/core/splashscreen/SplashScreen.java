...
public final class SplashScreen {
    ...
    private static class Impl {
        ...
        public static final boolean m56splashScreenWaitPredicate$lambda0() {
            return false;
        }
        ...
        public static final void m55dispatchOnExitAnimation$lambda3(SplashScreenViewProvider splashScreenViewProvider, OnExitAnimationListener onExitAnimationListener) {
            Intrinsics.checkNotNullParameter(splashScreenViewProvider, "$splashScreenViewProvider");
    ...
    private static final class Impl31 extends Impl {
        ...
        public static final void m57setOnExitAnimationListener$lambda0(Impl31 impl31, OnExitAnimationListener onExitAnimationListener, SplashScreenView splashScreenView) {
