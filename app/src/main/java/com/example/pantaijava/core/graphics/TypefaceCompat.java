...
public class TypefaceCompat {
    ...
    public static Typeface createFromResourcesFamilyXml(Context context, FontResourcesParserCompat.FamilyResourceEntry familyResourceEntry, Resources resources, int i, String str, int i2, int i3, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z) {
        ...
        if (familyResourceEntry2 instanceof FontResourcesParserCompat.ProviderResourceEntry) {
            ...
            boolean z2 = !z ? fontCallback2 == null : providerResourceEntry.getFetchStrategy() == 0;
            int timeout = z ? providerResourceEntry.getTimeout() : -1;
            Handler handler3 = ResourcesCompat.FontCallback.getHandler(handler);
            ...
            if (providerResourceEntry.getFallbackRequest() != null) {
                list = TypefaceCompat$$ExternalSyntheticBackport0.m(new Object[]{providerResourceEntry.getRequest(), providerResourceEntry.getFallbackRequest()});
            } else {
                list = TypefaceCompat$$ExternalSyntheticBackport0.m(new Object[]{providerResourceEntry.getRequest()});
            }
            typeface = FontsContractCompat.requestFont(context, (List<FontRequest>) list, i3, z2, timeout, handler3, (FontsContractCompat.FontRequestCallback) resourcesCallbackAdapter);
    ...
    public static class ResourcesCallbackAdapter extends FontsContractCompat.FontRequestCallback {
        ...
        public void onTypefaceRetrieved(Typeface typeface) {
            ...
            if (fontCallback != null) {
                fontCallback.m36lambda$callbackSuccessAsync$0$androidxcorecontentresResourcesCompat$FontCallback(typeface);
            }
        }
        ...
        public void onTypefaceRequestFailed(int i) {
            ResourcesCompat.FontCallback fontCallback = this.mFontCallback;
            if (fontCallback != null) {
                fontCallback.m35lambda$callbackFailAsync$1$androidxcorecontentresResourcesCompat$FontCallback(i);
            }
        }
    }
}
