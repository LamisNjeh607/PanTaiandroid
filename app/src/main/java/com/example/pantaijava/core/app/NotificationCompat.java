    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i = 0; i < remoteInputs.length; i++) {
                ...
                remoteInputArr2[i] = new RemoteInput(Api20Impl.getResultKey(remoteInput), Api20Impl.getLabel(remoteInput), Api20Impl.getChoices(remoteInput), Api20Impl.getAllowFreeFormInput(remoteInput), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, Api20Impl.getExtras(remoteInput), (Set<String>) null);
            }
