package com.example.pantaijava.lifecycle;
...
import androidx.lifecycle.SavedStateHandleSupport$VIEW_MODEL_STORE_OWNER_KEY$1;
...
public final class SavedStateHandleSupport {
    ...
    public static final  void enableSavedStateHandles(SavedStateRegistryOwner t) {
    ...
    public static final SavedStateHandlesVM getSavedStateHandlesVM(ViewModelStoreOwner viewModelStoreOwner) {
        ...
        initializerViewModelFactoryBuilder.addInitializer(Reflection.getOrCreateKotlinClass(SavedStateHandlesVM.class));
    ...
    public static void enableSavedStateHandles() {
        enableSavedStateHandles((SavedStateRegistryOwner) null);
    }
