...
public class AssetFilesystem extends Filesystem {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:43:0x0067 A[Catch:{ IOException -> 0x002c }] */
    ...
    private void lazyInitCaches() {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<java.lang.String, java.lang.String[]> r1 = listCache     // Catch:{ all -> 0x008a }
            if (r1 != 0) goto L_0x0088
            r1 = 0
            java.io.ObjectInputStream r2 = new java.io.ObjectInputStream     // Catch:{ ClassNotFoundException -> 0x004e, IOException -> 0x0040, all -> 0x003b }
            android.content.res.AssetManager r3 = r6.assetManager     // Catch:{ ClassNotFoundException -> 0x004e, IOException -> 0x0040, all -> 0x003b }
            java.lang.String r4 = "cdvasset.manifest"
            java.io.InputStream r3 = r3.open(r4)     // Catch:{ ClassNotFoundException -> 0x004e, IOException -> 0x0040, all -> 0x003b }
            r2.<init>(r3)     // Catch:{ ClassNotFoundException -> 0x004e, IOException -> 0x0040, all -> 0x003b }
        ...
        L_0x002c:
            ...
            java.lang.String r1 = r1.getLocalizedMessage()     // Catch:{ all -> 0x008a }
        L_0x0033:
            org.apache.cordova.LOG.d(r2, r1)     // Catch:{ all -> 0x008a }
            goto L_0x0063
        L_0x0037:
            r1 = r2
            goto L_0x0040
        ...
        L_0x0063:
            ...
            org.apache.cordova.LOG.w((java.lang.String) r1, (java.lang.String) r2)     // Catch:{ all -> 0x008a }
            java.util.HashMap r1 = new java.util.HashMap     // Catch:{ all -> 0x008a }
            r1.<init>()     // Catch:{ all -> 0x008a }
            listCache = r1     // Catch:{ all -> 0x008a }
            goto L_0x0088
        L_0x0076:
            r1 = move-exception
        L_0x0077:
        ...
        L_0x007d:
            ...
            java.lang.String r2 = r2.getLocalizedMessage()     // Catch:{ all -> 0x008a }
            org.apache.cordova.LOG.d(r3, r2)     // Catch:{ all -> 0x008a }
        L_0x0087:
