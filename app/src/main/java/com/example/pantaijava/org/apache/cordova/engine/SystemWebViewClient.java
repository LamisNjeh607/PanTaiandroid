...
public class SystemWebViewClient extends WebViewClient {
    ...
    public /* synthetic */ WebResourceResponse m1819lambda$new$0$orgapachecordovaengineSystemWebViewClient(SystemWebViewEngine systemWebViewEngine, String str) {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, String str) {
        try {
            if (!this.parentEngine.pluginManager.shouldAllowRequest(str)) {
                ...
                return new WebResourceResponse(AssetHelper.DEFAULT_MIME_TYPE, ByteWrangler.CHARSET_NAME, (InputStream) null);
            }
            ...
            return new WebResourceResponse(openForRead.mimeType, ByteWrangler.CHARSET_NAME, openForRead.inputStream);
        } catch (IOException e) {
