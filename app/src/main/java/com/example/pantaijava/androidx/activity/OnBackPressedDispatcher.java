...
public final class OnBackPressedDispatcher {
    ...
    public final void addCallback(OnBackPressedDispatcherKt$addCallback$callback$1 onBackPressedCallback) {
    ...
    public final void addCallback(LifecycleOwner lifecycleOwner, OnBackPressedDispatcherKt$addCallback$callback$1 onBackPressedCallback) {
    ...
    public static final class Api33Impl {
        ...
        public final void registerOnBackInvokedCallback(Object obj, int i, Object obj2) {
            ...
            Intrinsics.checkNotNullParameter(obj2, PluginMethod.RETURN_CALLBACK);
