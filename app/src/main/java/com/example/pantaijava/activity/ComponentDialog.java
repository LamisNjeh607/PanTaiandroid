...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner, SavedStateRegistryOwner {
    ...
    public ComponentDialog(Context context, int i) {
        ...
        this.onBackPressedDispatcher = new OnBackPressedDispatcher(new ComponentDialog$$ExternalSyntheticLambda0());
    }
    ...
    public final void onBackPressedDispatcher$lambda$1(ComponentDialog componentDialog) {
