...
public final class ComponentActivity$onBackPressedDispatcher$2  {
    ...
    public final void invoke$lambda$0(ComponentActivity componentActivity) {
        Intrinsics.checkNotNullParameter(componentActivity, "this$0");
        try {
            ComponentActivity$onBackPressedDispatcher$2.super.getClass();
    ...
    /* access modifiers changed from: private */
    public static  void invoke$lambda$2$lambda$1(ComponentActivity componentActivity, OnBackPressedDispatcher onBackPressedDispatcher) {
        Intrinsics.checkNotNullParameter(componentActivity, "this$0");
