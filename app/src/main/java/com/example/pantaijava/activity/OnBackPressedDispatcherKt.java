...
public final class OnBackPressedDispatcherKt {
    public static /* synthetic */ OnBackPressedDispatcherKt$addCallback$callback$1 addCallback$default(OnBackPressedDispatcher onBackPressedDispatcher, LifecycleOwner lifecycleOwner, boolean z, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            lifecycleOwner = null;
        }
        if ((i & 2) != 0) {
    ...
    public static final OnBackPressedDispatcherKt$addCallback$callback$1 addCallback(OnBackPressedDispatcher onBackPressedDispatcher, LifecycleOwner lifecycleOwner, boolean z, Function1<? super OnBackPressedCallback, Unit> function1) {
        Intrinsics.checkNotNullParameter(onBackPressedDispatcher, "<this>");
        Intrinsics.checkNotNullParameter(function1, "onBackPressed");
        OnBackPressedDispatcherKt$addCallback$callback$1 onBackPressedDispatcherKt$addCallback$callback$1 = new OnBackPressedDispatcherKt$addCallback$callback$1(z, (Function1<? super androidx.activity.OnBackPressedCallback, Unit>) function1);
