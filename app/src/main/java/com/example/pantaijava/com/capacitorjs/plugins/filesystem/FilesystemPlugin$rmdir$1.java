...
@DebugMetadata(c = "com.capacitorjs.plugins.filesystem.FilesystemPlugin$rmdir$1", f = "FilesystemPlugin.kt", i = {}, l = {174}, m = "invokeSuspend", n = {}, s = {})
...
final class FilesystemPlugin$rmdir$1 extends SuspendLambda implements Function2<IONFILEUri.Resolved, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(IONFILEUri.Resolved resolved, Continuation<? super Unit> continuation) {
        return ((FilesystemPlugin$rmdir$1) create(resolved, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj2 = this.this$0.getController().m155delete0E7RQCE((IONFILEUri.Resolved) this.L$0, new IONFILEDeleteOptions(this.$input.getRecursive()), this);
