...
@DebugMetadata(c = "com.capacitorjs.plugins.filesystem.FilesystemPlugin$readFile$1", f = "FilesystemPlugin.kt", i = {}, l = {77}, m = "invokeSuspend", n = {}, s = {})
...
final class FilesystemPlugin$readFile$1 extends SuspendLambda implements Function2<IONFILEUri.Resolved, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        FilesystemPlugin$readFile$1 filesystemPlugin$readFile$1 = new FilesystemPlugin$readFile$1(this.this$0, this.$input, this.$call, continuation);
    ...
    public final Object invoke(IONFILEUri.Resolved resolved, Continuation<? super Unit> continuation) {
        return ((FilesystemPlugin$readFile$1) create(resolved, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj2 = this.this$0.getController().m160readFile0E7RQCE((IONFILEUri.Resolved) this.L$0, this.$input.getOptions(), this);
