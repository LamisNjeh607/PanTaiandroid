...
@DebugMetadata(c = "com.capacitorjs.plugins.filesystem.FilesystemPlugin$readdir$1", f = "FilesystemPlugin.kt", i = {}, l = {187}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: FilesystemPlugin.kt */
final class FilesystemPlugin$readdir$1 extends SuspendLambda implements Function2<IONFILEUri.Resolved, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(IONFILEUri.Resolved resolved, Continuation<? super Unit> continuation) {
        return ((FilesystemPlugin$readdir$1) create(resolved, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj2 = this.this$0.getController().m158listDirectorygIAlus((IONFILEUri.Resolved) this.L$0, this);
        ...
        if (Result.m197isSuccessimpl(obj2)) {
            PluginResultExtensionsKt.sendSuccess$default(pluginCall, FilesystemMethodResultsKt.createReadDirResultObject((List) obj2), false, 2, (Object) null);
        }
