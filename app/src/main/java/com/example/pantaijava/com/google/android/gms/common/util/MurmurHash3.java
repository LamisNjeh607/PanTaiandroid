...
public class MurmurHash3 {
    ...
    public static int murmurhash3_x86_32(byte[] bArr, int i, int i2, int i3) {
        ...
        while (true) {
            ...
            int i6 = ((bArr[i5] & UByte.MAX_VALUE) | ((bArr[i5 + 1] & UByte.MAX_VALUE) << 8) | ((bArr[i5 + 2] & UByte.MAX_VALUE) << 16) | (bArr[i5 + 3] << 24)) * ScatterMapKt.MurmurHashC1;
        ...
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    i9 = (bArr[i4 + 2] & UByte.MAX_VALUE) << 16;
                }
                int i10 = i3 ^ i2;
        ...
        int i13 = ((bArr[i4] & UByte.MAX_VALUE) | i9) * ScatterMapKt.MurmurHashC1;
