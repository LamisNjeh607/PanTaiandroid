...
public class ProfileInstallerInitializer implements Initializer<Result> {
    ...
    public void m85lambda$delayAfterFirstFrame$0$androidxprofileinstallerProfileInstallerInitializer(Context context) {
        Handler28Impl.createAsync(Looper.getMainLooper()).postDelayed(new ProfileInstallerInitializer$$ExternalSyntheticLambda0(context), (long) (new Random().nextInt(Math.max(1000, 1)) + 5000));
    }
