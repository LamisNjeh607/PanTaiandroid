                ...
                if (job != null && !job.isActive()) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES()) {
                        if (continuation instanceof CoroutineStackFrame) {
                            ...
                            continuation.resumeWith(Result.m190constructorimpl(ResultKt.createFailure(th)));
                        }
                    }
                    ...
                    continuation.resumeWith(Result.m190constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.Companion;
                    continuation.resumeWith(Result.m190constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
                }
