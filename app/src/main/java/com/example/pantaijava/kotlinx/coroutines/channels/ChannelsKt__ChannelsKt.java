...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object r0 = sendChannel.m1748trySendJP2dKIU(e);
        if (r0 instanceof ChannelResult.Failed) {
            return ((ChannelResult) BuildersKt__BuildersKt.runBlocking$default((CoroutineContext) null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, (Continuation<? super ChannelsKt__ChannelsKt$trySendBlocking$2>) null), 1, (Object) null)).m1735unboximpl();
        }
        Unit unit = (Unit) r0;
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) {
        if (!ChannelResult.m1733isSuccessimpl(sendChannel.m1748trySendJP2dKIU(obj))) {
