...
public final class DelayKt {
    ...
    public static final Object m1697delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1698toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1698toDelayMillisLRDsOJo(long j) {
        boolean r0 = Duration.m1556isPositiveimpl(j);
        if (r0) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m1540getInWholeMillisecondsimpl(Duration.m1558plusLRDsOJo(j, DurationKt.toDuration(999999, DurationUnit.NANOSECONDS)));
        } else if (!r0) {
            return 0;
        } else {
