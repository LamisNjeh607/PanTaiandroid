...
class AppLocalesStorageHelper {
    ...
    static void persistLocales(Context context, String str) {
        ...
        try {
            ...
            try {
                ...
                newSerializer.startDocument(ByteWrangler.CHARSET_NAME, true);
    ...
    static class SerialExecutor implements Executor {
        ...
        public /* synthetic */ void m7lambda$execute$0$androidxappcompatappAppLocalesStorageHelper$SerialExecutor(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                scheduleNext();
